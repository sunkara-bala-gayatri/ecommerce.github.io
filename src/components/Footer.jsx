      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><Link to="/terms" className="text-text-muted text-sm hover:text-accent hover:pl-1 transition-all">Terms-Of-Use</Link></li>
            <li><a href="#" className="text-text-muted text-sm hover:text-accent hover:pl-1 transition-all">Track Orders</a></li>
            <li><a href="#" className="text-text-muted text-sm hover:text-accent hover:pl-1 transition-all">Shipping</a></li>
          </ul>
        </div>
